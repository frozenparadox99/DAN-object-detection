...
class SST(nn.Module):
    ...
    def __init__(self, phase, base, extras, selector, final_net, use_gpu=False):
    ...
    def add_unmatched_dim(self, x):
        if self.false_objects_column is None:
            ...
            if self.use_gpu:
                self.false_objects_column = self.false_objects_column
        ...
        if self.false_objects_row is None:
            ...
            if self.use_gpu:
                self.false_objects_row = self.false_objects_row
